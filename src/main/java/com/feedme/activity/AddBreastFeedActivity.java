    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addEntryButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                journalDao.addEntry(new Journal(entryDate.getText().toString(), entryTime.getText().toString(), entryMinLeft.getText().toString(), entryMinRight.getText().toString(), " ", Integer.parseInt(entryChild.getText().toString())));
